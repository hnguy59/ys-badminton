        ...
        <div className="flex flex-col gap-8 sm:flex-row">
          <div className="h-min flex-1">
            <Image
              ...
              src="/static/images/kids-training-group.jpg"
                  ...
                  <dl className="mt-10  space-y-8 text-base leading-7">
                    <div className="relative pl-9">
                      <dt className="inline font-semibold">
                        <StarIcon className="absolute left-1 top-1 h-5 w-5 text-indigo-600 dark:text-green-400" />
                        Excellence
                      </dt>{' '}
                    ...
                    <div className="relative pl-9">
                      <dt className="inline font-semibold">
                        <ShieldCheckIcon className="absolute left-1 top-1 h-5 w-5 text-indigo-600 dark:text-green-400" />
                        Integrity
                      </dt>{' '}
                      <dd className="text-justify">
                    ...
                    <div className="relative pl-9">
                      <dt className="inline font-semibold">
                        <AcademicCapIcon className="absolute left-1 top-1 h-5 w-5 text-indigo-600 dark:text-green-400" />
                        Personal Growth
                      </dt>{' '}
                      <dd className="text-justify">
